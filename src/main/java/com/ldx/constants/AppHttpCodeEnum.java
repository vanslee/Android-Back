...
public enum AppHttpCodeEnum {
    ...
    ADD_PICTURE_SUCCESS(703, "增加照片成功"),
    DELETE_PICTURE_SUCCESS(704, "删除照片成功"),
    UPDATE_PICTURE_SUCCESS(705, "更新照片成功"),
    ...
    EMAIL_ERROR(904, "邮箱号错误"),
    EMAIL_EXIST(905, "邮箱号存在"),
    NEED_LOGIN(401, "需要登录"),
    SYSTEM_ERROR(500, "出现错误"),
    LOGIN_ERROR(505, "用户名或密码错误"),
    REGISTRY_SUCCESS(200, "用户创建成功"),
    REGISTRY_ERROR(500, "用户创建失败");
